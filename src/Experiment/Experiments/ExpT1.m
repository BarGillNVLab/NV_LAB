classdef ExpT1 < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpT1(FG, MWChannel)
    ...
    methods (Access = protected)
       function prepare(obj)
        ...
        function perform(obj)
            ...
            k = 0; %added by rotem 04.10.21
            f1 = []; %added by rotem 04.10.21
            for t = randperm(length(obj.tau))
                ...
                success = false;
                f1 = [f1, t]; %added by rotem 04.10.21
                k = k + 1; %added by rotem 04.10.21
