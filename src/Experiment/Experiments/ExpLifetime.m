classdef ExpLifetime < Experiment
    %EXPT1 T1 experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpLifetime(FG, MWChannel)
            obj@Experiment(ExpLifetime.NAME);
            ...
            obj.excitationDuration = 0.05;           % detection window, in us
            ...
            obj.waitTime = 0.500;                     % Decay from Singlet
    ...
    methods
        ...
        function set.startFromOne (obj, newVal)
            checkBoolean(obj, newVal)
            % If we got here, then newVal is OK.
            obj.startFromOne = newVal;
            obj.changeFlag = true;
        end
    ...
    methods (Access = protected)
       function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                ...
                S.addEvent(obj.waitTime,                         '')                        % Delay for siglet decay
                if k == 2
                    S.addEvent(obj.piTime,      MWChannel,                  'initPulse');   % MW
                end

                S.addEvent(obj.excitationDuration, {'greenLaser', 'detector'});              % Detection
                S.addEvent(obj.detectionDuration - obj.excitationDuration, {'detector'});              % Detection
...
%                         end
                        ...
                        hist = spcm.lastExpHist;  % This is our rawData
%                         Hist = Hist+hist;
