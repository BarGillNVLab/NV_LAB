classdef ExpSingletLifetime < Experiment
    %EXPSingletLifetime Singlet Lifetime experiment
    
    properties (Constant)
        NAME = 'SingletLifetime';
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpSingletLifetime(FG, MWChannel)
            obj@Experiment(ExpSingletLifetime.NAME);
            ...
            obj.tau = 0.01:0.01:1;          % in us
            obj.piTime = 0.05;              % in us
            obj.PopulationDuration = 0.3;


            % For Singlet Lifetime, constantTime is added at the end, after detection! so
            % it is ok :)
