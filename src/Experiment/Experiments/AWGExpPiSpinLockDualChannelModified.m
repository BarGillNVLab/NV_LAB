classdef AWGExpPiSpinLockDualChannelModified < ExperimentAWG

    properties (Constant)
        NAME = 'AWG Spin Lcok Dual Channels Modified';
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = AWGExpPiSpinLockDualChannelModified()
...
%             obj.timeDelay = -0.003;
    ...
    methods (Access = protected)
        function prepare(obj)
           ...
           % obj.tauLimits(2) = ceil(obj.tauLimits(2)/obj.tauStep)*obj.tauStep;
...
%             obj.isPlotAlternateAvailable = obj.doubleMeasurement;
        ...
        function LoadAWG(obj)
            ...
            minWaveformTime = obj.AWG.minWaveformDuration;
                 ...
                 obj.tauLimits(1) = ceil(obj.tauLimits(1)/obj.tauStep)*obj.tauStep;
                obj.tauLimits(2)= floor(obj.tauLimits(2)/obj.tauStep)*obj.tauStep;
            if obj.tauLimits(1) ==  obj.tauLimits(2)
                print 'error'
            end
...
%             pg.changeSequence('preTime', 'duration', prePulseTime1 + obj.halfPiTime + 2*obj.delay + obj.piTime);
            ...
            centerPulseZeroIndex = obj.AWG.AddWaveformByFunction(@(t) f(t).*0, obj.tauStep, 0, 1);
            obj.AWG.LoadWaveform();
    
            % creating sequences:
            for i = obj.tauLimits(1)/obj.tauStep:1 :obj.tauLimits(2)/obj.tauStep
                ...
                obj.indexSeq(2, i) = obj.AWG.AddSequence([firstPulsesZeroIndex, centerPulseIndex, lastPulsesZeroIndex, firstPulsesZeroIndex, centerPulseIndex, lastPulsesZeroIndex], ...
                                                      [1, i, 1, 1, i, 1], [1 0 0 1 0 0] , i==2);
%                 obj.indexSeq(1, i) = obj.AWG.AddSequence([firstPulsesIndex, centerPulseZeroIndex, lastPulsesIndex, firstPulsesIndex, centerPulseZeroIndex, lastPulsesRefIndex], ...
%                                                       [1, i, 1, 1, i, 1], [1 0 0 1 0 0] , 1);
%                obj.indexSeq(2, i) = obj.AWG.AddSequence([firstPulsesZeroIndex, centerPulseIndex, lastPulsesZeroIndex, firstPulsesZeroIndex, centerPulseIndex, lastPulsesZeroIndex], ...
%                                                   [1, i, 1, 1, i, 1], [1 0 0 1 0 0] , 1);       
%                  obj.indexSeq(2, i) = obj.AWG.AddSequence([firstPulsesIndex, centerPulseIndex, lastPulsesZeroIndex, firstPulsesIndex, centerPulseIndex, lastPulsesZeroIndex], ...
%                                                       [1, i, 1, 1, i, 1], [1 0 0 1 0 0] , i==4);
