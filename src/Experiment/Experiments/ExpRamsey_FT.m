classdef ExpRamsey_FT < Experiment
    ...
    properties
        ...
        esr                 % esr experiment
        detuning            % detuning from esr center
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpRamsey_FT(FG, MWChannel)
            obj@Experiment(ExpRamsey_FT.NAME);
            ...
            obj.isTrackingEsr = true;       % logical
            
            obj.esrTrackOnAvg = 250;        % int
    ...
    methods (Access = protected)
        ...
        function trackFrequency(obj)
            ...
            esrFrq = obj.frequency - obj.detuning;
            f = fit(frq_esr', sig_esr, ft, 'Start', [0, 0.9, 6, esrFrq]);
            obj.frequency = f.u + obj.detuning;
        end
    end
end