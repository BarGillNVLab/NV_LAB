classdef ExpRamseyMwInit < Experiment
    %ExpRamsey Ramsey experiment

    properties (Constant)
        NAME = 'ExpRamseyMwInit';
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpRamseyMwInit(FG, MWChannel)
            obj@Experiment(ExpRamseyMwInit.NAME);
            ...
            obj.polarizationTime = 100;     % in us
            obj.greenAfterMW = 10;          % in us
    ...
    methods (Access = protected)
        function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                S.addEvent(obj.polarizationTime,{MWChannel,'MW2','greenLaser'},'init MW'); %this MW should be with frequency obj.frequency_of_minus1
                S.addEvent(obj.greenAfterMW,'greenLaser','green laser after MW delay time');
