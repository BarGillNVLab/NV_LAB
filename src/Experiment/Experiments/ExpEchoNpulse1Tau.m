classdef ExpEchoNpulse1Tau < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpEchoNpulse1Tau(FG, MWChannel)
            obj@Experiment(ExpEchoNpulse1Tau.NAME);
    ...
    methods (Access = protected)
        function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                ...
                S.addEvent(obj.tau/2,                    '',                         'tau'); % Delay
