classdef ExpRaamS3 < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpRaamS3(FG, MWChannel)
            obj@Experiment(ExpRaamS3.NAME);
