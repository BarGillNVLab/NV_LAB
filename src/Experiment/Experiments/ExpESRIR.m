classdef ExpESRIR < Experiment
    ...
    properties
        ...
        tau                 % in us. Delay between population and detection. 
    ...
    methods
        ...
        function obj = ExpESRIR(FGs, MWChannel)
            obj@Experiment(ExpESRIR.NAME);
            ...
            obj.amplitude = -3;        % dBm
            obj.phase = 0;
            obj.mode = 'pulsed';            % Can only be 'CW' for now.
            ...
            obj.detectionDuration = 0.25; %1;
            obj.referenceDetectionDuration = 0.25; %1;
            ...
            switch obj.mode
                case 'CW'
                    ...
                    switch obj.nChannels
                        case 1
                            P = Pulse(obj.detectionDuration,        {MWChannel, 'greenLaser', 'detector','IR'});
                        case 2
                            P = Pulse(obj.detectionDuration,        {MWChannel, 'MW2', 'greenLaser', 'detector','IR'});
                        otherwise
                    ...
                    S.addEvent(obj.referenceDetectionDuration,      {'greenLaser','detector','IR'})
                ...
                case 'pulsed'
                    ...
                    S.addEvent(obj.singletDelay,                       '');                        % Singlet delay
                    ...
                    S.addEvent(obj.tau,                         '')                         % Delay for excited state decay	
                    S.addEvent(obj.detectionDuration,           {'IR','detector'})          % Delay for excited state decay
                    S.addEvent(0.5,          {'IR'})
                    S.addEvent(obj.singletDelay,                       '');                        % Singlet delay
                    S.addEvent(initDuration,                    'greenLaser')               % Initialization to spin 0
                    S.addEvent(obj.singletDelay+obj.piTime(1)+lastDelay,                       '');                        % Singlet delay
                    S.addEvent(obj.PopulationDuration,          {'greenLaser'})               % Populating the singlet
                    S.addEvent(obj.tau,                         '')                         % Delay for excited state decay	
...
%                     S.addEvent(obj.detectionDuration,           {'IR','detector'})          % Delay for excited state decay
%                     S.addEvent(initDuration,                    'greenLaser')               % Initialization to spin 0
%                     S.addEvent(obj.tau + obj.piTime(1),                         '')                         % Delay for excited state decay
%                     S.addEvent(obj.PopulationDuration,          'greenLaser')               % Populating the singlet
%                     S.addEvent(obj.tau,                         '')                         % Delay for excited state decay	
