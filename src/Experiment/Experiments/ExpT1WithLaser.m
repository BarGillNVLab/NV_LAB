classdef ExpT1WithLaser < Experiment
    %ExpT1WithLaser T1 experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpT1WithLaser(FG, MWChannel)
            obj@Experiment(ExpT1WithLaser.NAME);
            ...
            obj.detectionDuration = 0.3;           % detection window, in us
