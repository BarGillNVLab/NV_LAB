classdef ExpESRSted < Experiment
    ...
    methods
        ...
        function obj = ExpESRSted(FGs, MWChannel)
            obj@Experiment(ExpESRSted.NAME);
            ...
            switch obj.mode
                case 'CW'
                    ...
                    switch obj.nChannels
                        case 1
                            P = Pulse(obj.detectionDuration,        {MWChannel, 'greenLaser', 'detector','STEDLaser'});
                        case 2
                            P = Pulse(obj.detectionDuration,        {MWChannel, 'MW2', 'greenLaser', 'detector','STEDLaser'});
                        otherwise
                            obj.sendError('What should we do here?')
                    end
                    
                    S.addEvent(obj.laserInitializationDuration,     {MWChannel, 'greenLaser','STEDLaser'});
                    S.addPulse(P);
                    S.addEvent(obj.laserInitializationDuration,     {'greenLaser','STEDLaser'});
                    S.addEvent(obj.referenceDetectionDuration,      {'greenLaser','detector', 'STEDLaser'})
                case 'pulsed'
                    if obj.laserInitializationDuration < obj.detectionDuration
