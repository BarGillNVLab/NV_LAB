classdef ExpESR_Nuclear_2 < Experiment
    ...
    properties
        ...
        electronPiTime      % pi time of the NV electron in us
        electronFreq        % frequency for the NV electron in MHz
        tau_0               % Delay between pi pulse and esr on nuclear in us
    ...
    methods
        ...
        function obj = ExpESR_Nuclear_2(FGs, MWChannel, passedExpName)
            
            if nargin == 3
               expName = passedExpName;
            else
               expName = ExpESR_Nuclear_2.NAME;
            end
    ...
    %% Setters
    methods
        function set.electronPiTime(obj, newVal)
            checkTimeScalar(obj, newVal)
            % If we got here, then newVal is OK.
            obj.electronPiTime = newVal;
            obj.changeFlag = true;
        end
        
        function set.electronFreq(obj, newVal)
            checkFrequencyVector(obj, newVal)
            % If we got here, then newVal is OK.
            obj.electronFreq = newVal;
            obj.changeFlag = true;
        end

        function set.tau_0(obj, newVal)
            checkTimeScalar(obj, newVal)
            % If we got here, then newVal is OK.
            obj.tau_0 = newVal;
            obj.changeFlag = true;
...
%                     S.addEvent(1000,                       '');
                    ...
                    S.addEvent(obj.electronPiTime, {'MW2'}, 'electronPiTime')
                ...
                for trial = 1 : 5
                    ...
                    try
                        ...
                        if obj.nChannels == 1
                            ...
                            fgs{1,1}.frequency = obj.frequency(i);
                            fgs{1,2}.frequency = obj.electronFreq;

                            if obj.equalChannels% This will run both channels at the same time
