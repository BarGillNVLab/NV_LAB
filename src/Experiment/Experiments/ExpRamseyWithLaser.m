classdef ExpRamseyWithLaser < Experiment
    %ExpRamseyWithLaser Ramsey experiment

    properties (Constant)
        NAME = 'RamseyWithLaser';
    end
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpRamseyWithLaser(FG, MWChannel)
            obj@Experiment(ExpRamseyWithLaser.NAME);
    ...
    methods (Access = protected)
        function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                ...
                S.addEvent(obj.tau(end),   {'greenLaser', 'greenLaserOneOrTwo'},        'tau'); % Delay
