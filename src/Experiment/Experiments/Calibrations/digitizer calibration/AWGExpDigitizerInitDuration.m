classdef AWGExpDigitizerInitDuration < ExperimentAWG
    
    properties (Constant)
        NAME = 'AWG init duration';
    end
    ...
    methods
        function obj = AWGExpDigitizerInitDuration()
            obj@ExperimentAWG(AWGExpDigitizerInitDuration.NAME);
            obj.parameterName = 'time';
            
            obj.repeats = 1000;
            obj.averages = 100;
            obj.frequency = 2687;           % in MHz
            obj.amplitude = -20 + [0 0];    % in dBm
