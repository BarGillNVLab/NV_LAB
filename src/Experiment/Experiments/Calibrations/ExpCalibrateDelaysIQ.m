classdef ExpCalibrateDelaysIQ < Experiment
    %ExpCalibrateDelaysIQ Echo experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpCalibrateDelaysIQ(FG, MWChannel)
            obj@Experiment(ExpCalibrateDelaysIQ.NAME);
        ...
        function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                ...
                if obj.useIQ %Pi Pulse-IQ
                    S.addEvent(obj.piTime,                  {'I', 'Q', MWChannel});                  % MW in y
                else
                ...
                S.addEvent(0.1,   '',             'lastDelay');       % Last delay
                S.addEvent(0.1,...
                                                            {'greenLaser', 'detector'});        % Detection
                S.addEvent(0.1,                    'greenLaser');                      % Initialization
                S.addEvent(0.1,...
