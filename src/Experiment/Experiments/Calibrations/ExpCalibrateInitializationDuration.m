classdef ExpCalibrateInitializationDuration < Experiment
    ...
    properties
        ...
        delay               % in us
        initializationDurations  % in us. A vector of the scanned detection times
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpCalibrateInitializationDuration(FG, MWChannel)
            obj@Experiment(ExpCalibrateInitializationDuration.NAME);
            ...
            obj.initializationDurations = 1:0.5:9; % detection windows, in \mus
...
%             obj.isPlotAlternateAvailable = true;
            ...
            obj.mCurrentXAxisParam = ExpParamDoubleVector('Initialization Duration', [], [], StringHelper.MICROSEC, obj.NAME);
    ...
    methods
        ...
        function set.initializationDurations(obj ,newVal)	% newVal in microsec
            checkDetectionDuration(obj, newVal);
            % If we got here, then newVal is OK.
            obj.initializationDurations = newVal;
