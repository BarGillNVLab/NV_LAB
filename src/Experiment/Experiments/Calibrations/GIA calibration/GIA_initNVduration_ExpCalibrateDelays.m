classdef GIA_initNVduration_ExpCalibrateDelays < ExperimentAWG
    
    properties (Constant)
        NAME = 'GIA init duration calibration';
    end
    ...
    methods
        function obj = GIA_initNVduration_ExpCalibrateDelays()
            ...
            obj.referenceDetectionDuration = 0.1;
            obj.GIMeas = 1;
...
%% Overridden from Experiment
    methods (Access = protected)
        ...
        function prepare(obj)
            ...
            S.addEvent(obj.delays(end),             {'greenLaser'},                 'initNV');      % GI reset
            ...
            S.addEvent(obj.AWG.TRIG_DURATION + obj.piTime+0.5, '');                                     % equal length dark window
            S.addEvent(lastDelay,                   '');                                            % equal length dark window
            S.addEvent(obj.delays(end),             {'greenLaser'},                 'initNV');      % GI reset
        ...
        function perform(obj)
            ...
            for t = randperm(length(obj.delays))
                ...
                for trial = 1 : 10
                    ...
                    try
                        pg.changeSequence('initNV', 'duration', obj.delays(t));
                        obj.AWG.Run;
