classdef GIA_GIgateDuration_ExpCalibrateDelays < ExperimentAWG
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = GIA_GIgateDuration_ExpCalibrateDelays(FG)
            ...
            obj.time = 0.01:0.01:0.5;
%             obj.time = 0.05:0.01:0.25;
%             obj.time = [1.068, 1.068];
    ...
    methods (Access = protected)        
        function prepare(obj)
            ...
            S.addEvent(max(obj.time),               {'greenLaser', 'GIgate', 'GIenable'}, 'time');
