classdef GIA_GIenable_GIgate_ExpCalibrateDelays < ExperimentAWG
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = GIA_GIenable_GIgate_ExpCalibrateDelays(FG)
    ...
    methods (Access = protected)        
        function prepare(obj)
            ...
            S = Sequence;
            S.addEvent(2,                           {'greenLaser'});
            S.addEvent(abs(max(obj.delays)),        {'greenLaser', 'GIenable'},             'delay1');
            S.addEvent(0,                           {'greenLaser', 'GIgate'},               'delay2');
            S.addEvent(abs(min(obj.delays)),        {'greenLaser', 'GIenable', 'GIgate'},   'delayBoth');
