classdef GIA_lastDelay_ExpCalibrateDelays < ExperimentAWG
    ...
    methods
        function obj = GIA_lastDelay_ExpCalibrateDelays()
            obj@ExperimentAWG(GIA_lastDelay_ExpCalibrateDelays.NAME);
...
%             S.addEvent(0,                            MW,                         'spacer')           % MW
            S.addEvent(obj.delays(end),                       '',                         'lastDelay');       % Last delay
