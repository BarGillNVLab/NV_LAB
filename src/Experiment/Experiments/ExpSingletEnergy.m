classdef ExpSingletEnergy < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpSingletEnergy(FG, MWChannel)
            obj@Experiment(ExpSingletEnergy.NAME);
            ...
            obj.detectionLaserPower = 0.3; % in whatever units the setup works with
    ...
    methods (Access = protected)
       function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                ...
                S.addEvent(obj.PopDuration,              {'greenLaser','greenLaserOneOrTwo'},'popDuration')                       % Populating the singlet
