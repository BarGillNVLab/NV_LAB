classdef ExpEchoNpulseWithACMagnetic1Tau < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpEchoNpulseWithACMagnetic1Tau(FG, MWChannel)
    ...
    methods (Access = protected)
        function prepare(obj)
            ...
            obj.mCurrentXAxisParam.value = obj.cycles*obj.tau;
        ...
        function loadRigolAWG(obj)
            ...
            obj.ACsource.setFreq(0.5/obj.tau);  
        ...
        function perform(obj)
            ...
            for t = randperm(length(obj.cycles))
...
%                         end
                        pg.setSequence(obj.privateSequences{t});
                        obj.setRigolNPulse(obj.cycles(t))
