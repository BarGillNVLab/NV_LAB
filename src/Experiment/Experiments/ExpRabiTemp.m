classdef ExpRabiTemp < Experiment
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    methods
        function obj = ExpRabiTemp(FG, MWChannel)
            obj@Experiment(ExpRabiTemp.NAME);
    ...
    methods (Access = protected)
       function prepare(obj)
            ...
            for k = 1:1+obj.doubleMeasurement
                S.addEvent(1,                   '',                         'Delay');                %1usec delay
                if k==1
                    S.addEvent(obj.tau(end),        MWChannel,                  'MW')                % MW
                else
                    S.addEvent(obj.tau(end),        '',                  'DoubleMeasurementDelay')   % DoubleMeasurement
                end
