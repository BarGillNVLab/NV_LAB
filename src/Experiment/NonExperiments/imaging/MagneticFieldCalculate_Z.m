function [B_z] = MagneticFieldCalculate_Z(dips, I_helm, theta,theta_x,theta_y,Delta)
% dips - matrix of the data (m*n*2)
% B_calc_XYZ - the expected magnetic field in helmholtz system
% theta - the rotate angle of the diamond in the helmholtz system
...
% sings = sign(B_calc_NV);                                        % the signs of the magnetic field on each orientation
