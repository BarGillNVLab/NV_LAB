...
elseif strcmpi(type, 'TxMode') == 1
    ...
    elseif strcmpi(name, 'FFT') == 1
        value = 48;
    elseif strcmpi(name, 'MultiSegment') == 1
        value = hex2dec('40000000');
    elseif strcmpi(name, 'Multi Segment') == 1
        value = hex2dec('40000000');        
    end;
...
%        value = 8;        
    ...
    elseif strcmpi(name, 'fft4096') == 1
        value = 512;                             
    elseif strcmpi(name, 'fft 8192') == 1
        value = 64;                        
    elseif strcmpi(name, 'fft8192') == 1
        value = 64;                             
    elseif strcmpi(name, 'fft') == 1
        value = 576; % all fft values OR'ed together
    elseif strcmpi(name, 'histogram') == 1
        value = 16385;
    end;
end;   
