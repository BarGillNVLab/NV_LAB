...
acqInfo.SampleRate = 1000;
acqInfo.ExtClock = 0;
acqInfo.Mode = CsMl_Translate('Single', 'Mode');
acqInfo.SegmentCount = 5;
acqInfo.Depth = 8128; %8160;
acqInfo.SegmentSize = 8160;
acqInfo.TriggerTimeout = 10000000;
acqInfo.TriggerHoldoff = acqInfo.SegmentSize - acqInfo.Depth;
