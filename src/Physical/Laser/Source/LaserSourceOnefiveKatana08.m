classdef LaserSourceOnefiveKatana08 < LaserPartAbstract & SerialControlled
    %LASERSOURCEONEFIVEKATANA08 laser source RS232 controller
    ...
    methods
        % constructor
        function obj = LaserSourceOnefiveKatana08(name, port)
    ...
    methods (Static)
        function obj = create(name, jsonStruct)
            ...
            obj = LaserSourceOnefiveKatana08(name, port);
        end
    end
    %%
