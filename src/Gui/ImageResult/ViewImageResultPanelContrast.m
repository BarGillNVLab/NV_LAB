classdef ViewImageResultPanelContrast < GuiComponent
    ...
    methods
        function obj = ViewImageResultPanelContrast(parent, controller)
            ...
            obj.radioDifference = uicontrol(obj.PROP_RADIO{:}, 'Parent', bgMain, ...
                'String', 'Diff', ...
                'Position', [paddingFromLeft 65 rbWidth rbHeight], ...  % [fromLeft, fromBottom, width, height]
                'Tag', ImageScanResult.CONTRAST_OPTIONS{1});
            obj.radioRatio = uicontrol(obj.PROP_RADIO{:}, 'Parent', bgMain, ...
                'String', 'Ratio', ...
                'Position', [paddingFromLeft 45 rbWidth rbHeight], ...  % [fromLeft, fromBottom, width, height]
                'Tag', ImageScanResult.CONTRAST_OPTIONS{2});
            obj.radioWithout = uicontrol(obj.PROP_RADIO{:}, 'Parent', bgMain, ...
                'String', 'Without', ...
                'Position', [paddingFromLeft 25 rbWidth rbHeight], ...  % [fromLeft, fromBottom, width, height]
