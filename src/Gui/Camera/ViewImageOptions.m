classdef ViewImageOptions < ViewHBox
    properties
    end
    
    methods
        function obj = ViewImageOptions(parent, controller)
            ...
            startstop = ViewStartStop(bottomleftHBox, controller);
            countsperPixel = ViewCountsperPixel(bottomleftHBox, controller);            
            ...
            plotoptions = ViewPlotOptions(rightVBox, controller);
